            ...
            <tbody>
              {rows.map((r) => (
                <tr key={r.id} className="border-t border-slate-100">
                  ...
                  <td className="px-2 py-2.5 text-right text-slate-600">{r.otherEarning > 0 ? "+" + fmtINR(r.otherEarning) : "—"}</td>
                  <td className="px-2 py-2.5 text-right text-rose-600">{(r.deductions + r.otherDeduction) > 0 ? "−" + fmtINR(r.deductions + r.otherDeduction) : "—"}</td>
