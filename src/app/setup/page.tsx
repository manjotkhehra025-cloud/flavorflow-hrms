    ...
    <main className="flex min-h-screen items-center justify-center bg-[#0a1628] px-4 py-10">
      ...
      <div className="w-full max-w-md animate-fade-up">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-400 to-emerald-600 text-2xl font-black text-[#0a1628] shadow-[0_8px_24px_-4px_rgb(16_185_129_/_55%)]">H</div>
