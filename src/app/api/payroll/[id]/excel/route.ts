  ...
  if (kind === "register") {
    buf = await makeXlsx({
      ...
      columns: [
        ...
        { header: "OT ₹", width: 10 }, { header: "DA ₹", width: 9 }, { header: "Off-duty ₹", width: 10 }, { header: "Reward +₹", width: 11 },
      ...
      rows: [
        ...M.map(({ r, name, dept, monthly, fullBase }) => [
          ...
          r.payableDays, r.lopDays, fullBase, r.deductions, r.otAmount, r.daAmount || "", r.offWorkPay || "", r.otherEarning,
    ...
    buf = await makeXlsx({
      ...
      rows: M.map(({ r, name }) => [
        ...
        r.lopDays || "", r.deductions || "", r.pfEmployee || "", r.esiEmployee || "", r.advanceRecover || "", r.otherDeduction || "",
